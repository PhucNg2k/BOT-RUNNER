...
class User(Base):
    ...
    # API credentials for trading (legacy - moved to ExchangeCredentials)
...
class Subscription(Base):
    ...
    # Runner information (link to Docker containers)
    runner_id = Column(String(255))  # Links to RunnerManager container ID
    ...
    trial_expires_at = Column(DateTime)          # Trial expiration
